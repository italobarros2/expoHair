<!-- Hero section -->
<!--<section class="hero-section set-bg" data-setbg="--><?//=base_url('static/img/bg.jpg')?><!--" >-->
<!--    <div class="container">-->
			...
			<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="<?= base_url('static/img/possivel.jpg')?>" style="display: inline" class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="<?= base_url('static/img/possivel-2.jpg')?>" class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="<?= base_url('static/img/possivel-3.jpeg')?>" class="d-block w-100" alt="...">
					</div>
				</div>
...
<!-- Services section -->
<section class="services-section spad set-bg" data-setbg="<?=base_url('static/img/service-bg.png')?>" style="background-position: bottom 0px left -150px">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 service text-white">
                ...
                <h2>Salão Cabelereiro</h2>
                <p>No ExpoHair você encontra tudo sobre Cabelereiro que é um serviço ou estabelecimento comercial onde profissionais se dedicam a cortar, pentear, colorir e tratar os cabelos de clientes.</p>
            </div>
            <!-- service -->
            <div class="col-lg-4 col-md-6 service text-white">
...
<section class="testimonials-section set-bg" data-setbg="<?=base_url('static/img/review-bg.jpg')?>">
    <div class="container">
...
<!-- brands section -->
<div class="brands-section set-bg" data-setbg="<?=base_url('static/img/brands-bg.jpg')?>">
    <div class="brands-slider owl-carousel">
        ...
        <div class="bs-item">
            <img src="<?=base_url('static/img/brands/3.png')?>" alt="">
        </div>
        <div class="bs-item">
            <h4 style="margin-top: 40px">Seja nosso Parceiro</h4>
        </div>
        <div class="bs-item">
            <img src="<?=base_url('static/img/brands/5.png')?>" alt="">
        </div>
    </div>
</div>
