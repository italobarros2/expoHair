            ...
            <div class="card-body">
                <form><!--?=base_url('static/assets/images/logo.png')?>-->
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="username" type="text" placeholder="Usuário" autocomplete="off" style="margin-top: 12px"><i class="fas fa-user fixicon"></i>
                    </div>
